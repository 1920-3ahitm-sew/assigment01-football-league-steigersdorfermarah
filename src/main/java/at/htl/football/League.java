...
public class League {
    ...
    public List<Team> getTable(){
        ...
        for (int i = 0; i < teams.size(); i++) {
            ...
            System.out.printf("%s  ",teams.get(i).getName());
            ...
            System.out.printf("\t\t %2d   %2d   %2d   %2d   %2d   %2d   %2d  \n", teams.get(i).getPoints(), teams.get(i).getWins(), teams.get(i).getDraws(), teams.get(i).getDefeats(), teams.get(i).getGoalsShot(), teams.get(i).getGoalsReceived(),(teams.get(i).getGoalsShot() - teams.get(i).getGoalsReceived()));
